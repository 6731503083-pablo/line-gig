        ...
        data = [
          {
            ...
            description: "Looking for a skilled web developer to build a responsive website. Must have experience with React and Node.js.",
            budget: "$1000 - $2000",
            employerId: 1,
            requirements: "Experience with React, Node.js, and CSS.",
            deadline: "2023-12-31",
            status: "Open",
